...
public class ExceptionHandlerController {
  ...
  // 의도적으로 NullPointerException를 던지는 핸들러 메서드
  @GetMapping("/controller-null")
  public String nullPointerExceptionTest(){
    String str = null;
    System.out.println(str.charAt(0)); // NullPointerException이 던져짐
    return "/";
  }

  // 의도적으로 MemberRegistException를 던지는 핸들러 메서드
  @GetMapping("/controller-user")
  public String userExceptionTest() throws MemberRegistException{
    boolean check = true;
    if(check) throw new MemberRegistException("회원으로 받아줄 수 없음");
    return "/";
  }
