package com.wjdqudwls.section02.initdestroy.subsection02.annotation;
...
public class Application {
  public static void main(String[] args) {
    ...
    ApplicationContext applicationContext
        = new AnnotationConfigApplicationContext("com.wjdqudwls.section02.initdestroy.subsection02.annotation");
