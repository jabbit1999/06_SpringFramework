package com.wjdqudwls.section01.aop;
...
public class LoggingAspect {
  ...
  // Pointcut(삽입 시점)
  @Pointcut("execution(* com.wjdqudwls.section01.aop.*Service.*(..))")
  // 첫번쨰 * = 접근제어자(모든), 두번쨰 * = 메서드, (..) = 매개변수 0~N 코드가 끼워진 모든 시점
  ...
  @After("logPointcut()") // 현재 클랫에 있는 logPointcut() 지정
  public void logAfter(JoinPoint joinPoint) {
    System.out.println("===== 여기가 에프터야 =====");
