package com.wjdqudwls.section01.autowired.subsection03.setter;
...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext context = new AnnotationConfigApplicationContext("com.wjdqudwls.section01");
