package com.wjdqdwls.requestmapping;
...
public class ClassMappingTestController {
  ...
  /* 여러 주소 값을 하나의 핸드러 메서드에 매핑 */
  @PostMapping(value = {"/modify", "/delete"})
  public String modifyAndDeleteOrder(Model model){
    model.addAttribute("message", "POST 방식의 주문 수정 또는 삭제 헨들러 메서드 호출");

    return "mappingResult";
  }
//  @PostMapping("/delete")
//  public String deleteOrder(Model model){
//    model.addAttribute("message", "POST 방식의 주문 삭제 헨들러 메서드 호출");
//
//    return "mappingResult";
//  }
