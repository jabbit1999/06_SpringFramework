package com.wjdqdwls.handlermethod;
...
public class FirstController {
   ...
   *   매개 변수에 작성된 변수에 맞게 인자를 준비해주는 해결샤
   * - ArgumentResolver의 기스트에 작성된 타입이 호출되면
   *   자동으로 생성 또는 찾아서 주입
   * */
  ...
  public String registMenu(Model model, WebRequest req) {
    ...
    String message = String.format("%s을/를 신규 메뉴 목록의 %d번 카테고리에 %d원으로 등록했습니다.",
   ...
   *  2) Model.addAddAttribute ("key1", "value1")
