package com.beyond.section03.proxy.subsection02.cglib;

import com.beyond.section03.proxy.common.OhgiraffersStudent;
...
public class Application {
  public static void main(String[] args) {
    ...
    /*
    * Enhancer 클래스의 create static 메소드는
    * 타겟 클래스의 메타정보와 핸들러를 전달하면
    * proxy를 생성해서 반환해준다.
    */
